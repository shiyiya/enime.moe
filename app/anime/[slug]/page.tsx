    ...
    return (
        <>
            ...
            <div className={classNames(styles.desc, "mb-[5rem]")}>
                ...
                <p className={classNames(styles["desc-text"], "pt-2")}>{ description.replace(/(?:<br>\s*)+/g, `<br>`) }</p>
            </div>
            <div className={classNames(styles.eparrows, "flex flex-row flex-nowrap items-center m-0 overflow-x-scroll w-full pr-5 pl-5 mb-[5rem]")}>
